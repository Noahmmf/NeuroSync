...
router.post('/', rejectUnauthenticated, (req, res) => {
  ...
  console.log(`here is the insert for task:`, user, req.body.task_details, req.body.is_complete);

  pool.query(queryText, [user, req.body.task_details, req.body.is_complete])
